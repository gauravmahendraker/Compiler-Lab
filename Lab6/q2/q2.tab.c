...
{
  "\"end of file\"", "error", "\"invalid token\"", "OP", "CP", "OB", "CB",
  "END", "$accept", "input", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: input END  */
#line 14 "q2.y"
                 {printf("Balanced");exit(0);}
#line 1070 "q2.tab.c"
    break;
